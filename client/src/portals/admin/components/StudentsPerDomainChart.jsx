...
/**
 * StudentsPerDomainChart - Displays active students per domain with date filtering
 */
function StudentsPerDomainChart({ data }) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
      <div className="mb-4">
        <h2 className="text-lg font-semibold text-zinc-100 mb-1">Active Students per Domain</h2>
      ...
      <ColumnChart data={data} height={200} />
    </div>
  );
}

export default StudentsPerDomainChart;
