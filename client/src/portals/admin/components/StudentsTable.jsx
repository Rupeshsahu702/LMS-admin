...
import { SearchIcon, ChevronDown, Download, Pencil } from 'lucide-react';
import {
  flexRender,
  getCoreRowModel,
  getFacetedRowModel,
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <Popover
              open={openCertificatePopoverId === rowIndex}
              onOpenChange={open => setOpenCertificatePopoverId(open ? rowIndex : null)}
            >
                  ...
                  <div className="space-y-3 py-3 border-y border-zinc-800">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex flex-row items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            navigator.clipboard.writeText(student.paymentId || 'TXN_123456789')
                          }
